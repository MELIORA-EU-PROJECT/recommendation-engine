...
def generate_user_profile():
    ...
    countries = ["USA", "UK", "Germany", "France", "Italy", "Spain", "Russia", "China", "Japan", "India", "Brazil",
                 ...
                 "Morocco", "Tunisia", "Algeria", "Libya", "Sudan", "Uganda", "Angola", "Zimbabwe", "Zambia",
                 "Mozambique",
                 ...
                 "Democratic Republic of the Congo", "Angola", "Namibia", "Botswana", "Zimbabwe", "Mozambique",
                 "Malawi",
                 "Zambia", "Tanzania", "Burundi", "Rwanda", "Uganda", "Kenya", "Somalia", "Djibouti", "Eritrea",
                 "Sudan",
                 "South Sudan", "Central African Republic", "Chad", "Niger", "Mali", "Burkina Faso", "Senegal",
                 "Gambia",
                 "Guinea-Bissau", "Guinea", "Sierra Leone", "Liberia", "Ivory Coast", "Ghana", "Togo", "Benin",
                 "Nigeria",
                 "Cameroon", "Equatorial Guinea", "Gabon", "Congo", "Democratic Republic of the Congo", "Angola",
                 "Namibia",
    ...
    educational_levels = ["no_education", "primary", "no high school diploma", "high school", "trade training",
                          "bachelor",
                          "master", "phd"]
    ...
    employment_statuses = ["employed", "self-employed", "out of work", "homemaker", "student", "retired",
                           "unable to work"]
