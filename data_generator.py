...
def generate_user_profile():
	...
	countries = ["USA", "UK", "Germany", "France", "Italy", "Spain", "Russia", "China", "Japan", "India", "Brazil", "Mexico", "Canada", "Australia", "South Africa", "Nigeria", "Egypt", "Kenya", "Ethiopia", "Ghana", "Morocco", "Tunisia", "Algeria", "Libya", "Sudan", "Uganda", "Angola", "Zimbabwe", "Zambia", "Mozambique", "Namibia", "Botswana", "Lesotho", "Swaziland", "Tanzania", "Rwanda", "Burundi", "Uganda", "Kenya", "Somalia", "Djibouti", "Eritrea", "Sudan", "South Sudan", "Central African Republic", "Chad", "Niger", "Mali", "Burkina Faso", "Senegal", "Gambia", "Guinea-Bissau", "Guinea", "Sierra Leone", "Liberia", "Ivory Coast", "Ghana", "Togo", "Benin", "Nigeria", "Cameroon", "Equatorial Guinea", "Gabon", "Congo", "Democratic Republic of the Congo", "Angola", "Namibia", "Botswana", "Zimbabwe", "Mozambique", "Malawi", "Zambia", "Tanzania", "Burundi", "Rwanda", "Uganda", "Kenya", "Somalia", "Djibouti", "Eritrea", "Sudan", "South Sudan", "Central African Republic", "Chad", "Niger", "Mali", "Burkina Faso", "Senegal", "Gambia", "Guinea-Bissau", "Guinea", "Sierra Leone", "Liberia", "Ivory Coast", "Ghana", "Togo", "Benin", "Nigeria", "Cameroon", "Equatorial Guinea", "Gabon", "Congo", "Democratic Republic of the Congo", "Angola", "Namibia", "Botswana", "Zimbabwe", "Mozambique", "Malawi", "Zambia", "Tanzania", "Burundi", "Rwanda", "Uganda", ]
	...
	educational_levels = ["no_education", "primary", "no high school diploma", "high school", "trade training", "bachelor", "master", "phd"]
	...
	household_economic_statuses = ["above average", "slightly above average", "average", "slightly below average", "below average"]
	...
	mental_conditions = ["anxiety disorder", "bipolar disorder", "depression", "dissociation", "eating disorders", "obsessive compulsive disorder", "paranoia", "post-traumatic stress disorder", "psychosis", "schizophrenia"]
	...
	alcohol_frequencies = ["never", "monthly or less", "2-4 times per month", "2-3 times per week", "4 or more times per week"]
	...
	fruit_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	vegetable_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	nuts_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	fish_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	whole_grain_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	refined_grain_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	low_fat_dairy_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	high_fat_dairy_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
	...
	sweets_frequencies = ["I do not eat it at all", "Less than 1 serving per week", "1-2 servings per week", "3-4 servings per week", "5-6 servings per week", "1 serving per day", "2-3 servings per day", "4-5 servings per day", "6 or more servings per day"]
